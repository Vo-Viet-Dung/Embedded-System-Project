...
{
	 unsigned char chuc0, donVi0, chuc1, donVi1, i;
	 chuc0 = giay/10; donVi0 = giay%10;
	 chuc1 = muoims/10; donVi1 = muoims%10;

	 for(i=0;i<1;i++)
	 {
	 	
	 	LED7SEG_1 = 0; P0 = LEDfont[chuc0]; delay_ms(2); LED7SEG_0 = 1;
		LED7SEG_0 = 0; P0 = LEDfont_2[donVi0]; delay_ms(2); LED7SEG_1 = 1;

		LED7SEG_3 = 0; P0 = LEDfont[chuc1]; delay_ms(2); LED7SEG_2 = 1;
		LED7SEG_2 = 0; P0 = LEDfont[donVi1]; delay_ms(2); LED7SEG_3 = 1;
		delay_ms(2);
	 } 
}
//Chuong trinh chinh				
